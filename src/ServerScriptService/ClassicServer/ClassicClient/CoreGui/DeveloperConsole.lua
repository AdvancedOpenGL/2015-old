--Include
local Create = assert(_G.LoadLibrary("RbxUtility")).Create

-- A Few Script Globals
local gui
if script.Parent.Parent.symlink.Value:FindFirstChild("ControlFrame") then
	gui = script.Parent.Parent.symlink.Value:FindFirstChild("ControlFrame")
else
	gui = script.Parent.Parent.symlink.Value
end
