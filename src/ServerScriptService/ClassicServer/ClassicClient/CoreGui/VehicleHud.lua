...
--[[ Images ]]--
local VEHICLE_HUD_BG = 'rbxassetid://16081130915'--'rbxasset://textures/ui/Vehicle/SpeedBarBKG.png'
local SPEED_BAR_EMPTY = 'rbxassetid://16081130701'--'rbxasset://textures/ui/Vehicle/SpeedBarEmpty.png'
local SPEED_BAR = 'rbxassetid://16081131049'--'rbxasset://textures/ui/Vehicle/SpeedBar.png'

--[[ Constants ]]--
local BOTTOM_OFFSET = 84+30+30
local MAX_SIZE = 142
...
local function onSeated(active)
	if active then
		...
		if camSubject and camSubject:IsA('VehicleSeat') then
			...
			wasEnabled = CurrentVehicleSeat.HeadsUpDisplay
			CurrentVehicleSeat.HeadsUpDisplay = false
		...
		if CurrentVehicleSeat then
			VehicleHudFrame.Visible = false
			CurrentVehicleSeat.HeadsUpDisplay = wasEnabled
