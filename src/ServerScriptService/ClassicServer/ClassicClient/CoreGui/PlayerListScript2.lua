...
local RobloxReplicatedStorage = game.ReplicatedStorage	-- NOTE: Can only use in core scripts
...
if IsServerCoreScripts then
	RobloxReplicatedStorage = game:GetService('ReplicatedStorage')
...
--[[ Images ]]--
local EXPAND_ICON = 'rbxassetid://10584651299'
local CHAT_ICON = 'rbxassetid://16080947161'--'rbxasset://textures/ui/chat_teamButton.png'
local ADMIN_ICON = 'rbxassetid://16081011012'--'rbxasset://textures/ui/icon_admin-16.png'
local PLACE_OWNER_ICON = 'rbxassetid://16081010097'--'rbxasset://textures/ui/icon_placeowner.png'
local FRIEND_ICON = 'rbxassetid://16081010326'--'rbxasset://textures/ui/icon_friends_16.png'
local FRIEND_REQUEST_ICON = 'rbxassetid://16081010554'--'rbxasset://textures/ui/icon_friendrequestsent_16.png'
local FRIEND_RECEIVED_ICON = 'rbxassetid://16081010723'--'rbxasset://textures/ui/icon_friendrequestrecieved-16.png'

local FOLLOWER_ICON = 'rbxassetid://16081010874'--'rbxasset://textures/ui/icon_follower-16.png'
local FOLLOWING_ICON = 'rbxasset://textures/ui/icon_following-16.png'
local MUTUAL_FOLLOWING_ICON = 'rbxassetid://16081053972'--'rbxasset://textures/ui/icon_mutualfollowing-16.png'
...
local function getMembershipIcon(player)
	...
	elseif membershipType == Enum.MembershipType.Premium then
		return "rbxassetid://16081009921"--"rbxasset://textures/ui/PlayerList/PremiumIcon.png"
	else
...
ScrollList.BottomImage = 'rbxassetid://16080947019'--'rbxasset://textures/ui/scroll-bottom.png'
ScrollList.MidImage = 'rbxassetid://16080946863'--'rbxasset://textures/ui/scroll-middle.png'
ScrollList.TopImage = 'rbxassetid://16080946662'--'rbxasset://textures/ui/scroll-top.png'
...
-- NOTE: Core script only
game:GetService("UserInputService").InputBegan:Connect(function(input,use)
	if not use and input.KeyCode == Enum.KeyCode.Tab then
		doListExpand()
	end
end)
...
pcall(function()
	onCoreGuiChanged(Enum.CoreGuiType.PlayerList, true)--game:GetService("StarterGui"):GetCoreGuiEnabled(Enum.CoreGuiType.PlayerList))
...
task.spawn(function()
	while true do
		task.wait()
		local value = RobloxReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("playerlist").Value
		if value ~= lastValue then
			onCoreGuiChanged(Enum.CoreGuiType.PlayerList,value)
		end
		lastValue = value
	end
end)
