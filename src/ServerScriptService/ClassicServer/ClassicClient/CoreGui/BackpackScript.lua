...
local ARROW_IMAGE_OPEN = "rbxassetid://16081079772"--'rbxasset://textures/ui/Backpack_Open.png'
local ARROW_IMAGE_CLOSE = "rbxassetid://16081080023"--'rbxasset://textures/ui/Backpack_Close.png'
...
pcall(function() TopBarEnabled = false end)
...
local lastValue1 = false
local starterGui = game:GetService("StarterGui")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
task.spawn(function() 
	while true do
		task.wait()
		local value = ReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("backpack").Value
		if value ~= lastValue then
			OnCoreGuiChanged(Enum.CoreGuiType.Backpack,value)
		end
		lastValue = value
		local value1 = ReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("health").Value
		if value1 ~= lastValue1 then
