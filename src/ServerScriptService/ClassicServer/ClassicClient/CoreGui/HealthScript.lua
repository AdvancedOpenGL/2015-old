...
local greenBarImage = "rbxassetid://16080966080"--rbxasset://textures/ui/Health-BKG-Center.png"
local greenBarImageLeft = "rbxassetid://16080965955"--"rbxasset://textures/ui/Health-BKG-Left-Cap.png"
local greenBarImageRight = "rbxassetid://16080965800"--rbxasset://textures/ui/Health-BKG-Right-Cap.png"
...
function CreateGui()
	if HealthGui and #HealthGui:GetChildren() > 0 then 
		HealthGui.Parent = script.Parent.Parent.symlink.Value
		return 
	end
...
function startGui()
	...
	if not ReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("health").Value then
		return
	end
...
task.spawn(function()
	while true do
		task.wait()
		local value = ReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("health").Value
		if value ~= lastValue then
			onCoreGuiChanged(Enum.CoreGuiType.Health,value)
		end
		lastValue = value
	end
end)

if ReplicatedStorage:WaitForChild("CoreGuiEnabled"):WaitForChild("health").Value then
	guiEnabled = true
	startGui()
end
