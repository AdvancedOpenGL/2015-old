...
local function isShiftLockMode()
	return game.ReplicatedStorage.shiftlock.Value
end
...
--[[ Constants ]]--
local SHIFT_LOCK_OFF = 'rbxassetid://10584650091'
local SHIFT_LOCK_ON = 'rbxassetid://10584649734'
...
local function initialize()
	...
	frame.Position = UDim2.new(0, 0, 1, -66)
